...
// Nayi files (Check karen ke ye components folder ke andar hi hain)
...
function App() {
  ...
  const styles = `
    ...
    .main-content { flex: 1; margin-left: 0; padding: 20px; padding-top: 70px; }
  ...
  return (
    <div className="app-wrapper">
      ...
      <main className="main-content">
        ...
        {/* Safe Render for New Modules */}
        {activeTab === 'reports' && Reports ? <Reports /> : null}
        {activeTab === 'expenses' && ExpenseTracker ? <ExpenseTracker /> : null}
      </main>
    </div>
  );
}
